...
library Clones {
    ...
    function computeProxyBytecodeHash(address implementation) internal pure returns (bytes32 bytecodeHash) {
        assembly ("memory-safe") {
            mstore(0, 0x3d602d80600a3d39000000000000000000000000000000000000000000000000)
            mstore(23, 0x5af43d82803e903d91602b57fd5bf3)
            mstore(8, or(0x81f3363d3d373d3d3d363d730000000000000000000000000000000000000000, implementation))
