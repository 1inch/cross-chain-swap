...
contract ResolverMock is IResolverMock, Ownable {
    ...
    function deploySrc(
        ...
        IEscrow.Immutables memory immutablesMem = immutables;
     ...
     */
    function deployDst(IEscrow.Immutables calldata dstImmutables, uint256 srcCancellationTimestamp) external onlyOwner payable {
