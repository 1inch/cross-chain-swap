...
Audit reports are published in [1inch/1inch-audits](https://github.com/1inch/1inch-audits):

- **v1.0** — [Cross-chain Protocol](https://github.com/1inch/1inch-audits/tree/master/Cross-chain%20Protocol)
- **v1.1** — [Crosschain fees v1.1](https://github.com/1inch/1inch-audits/tree/master/Crosschain%20fees%20v1.1)
